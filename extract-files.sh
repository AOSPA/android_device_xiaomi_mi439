...
extract "${MY_DIR}/proprietary-files/qcom-system.txt" "${SRC}" "${KANG}" --section "${SECTION}"
extract "${MY_DIR}/proprietary-files/qcom-vendor.txt" "${SRC}" "${KANG}" --section "${SECTION}"
extract "${MY_DIR}/proprietary-files/qcom-vendor-32.txt" "${SRC}" "${KANG}" --section "${SECTION}"
